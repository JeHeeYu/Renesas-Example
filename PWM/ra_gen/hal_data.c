...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.00005 seconds. Actual duty: 100%. */.period_counts = (uint32_t) 0x960,
  .duty_cycle_counts = 0x960, .source_div = (timer_source_div_t) 0, .channel = 9, .p_callback = NULL,
