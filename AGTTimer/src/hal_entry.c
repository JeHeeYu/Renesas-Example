...
int _write(int file, char *p, uint8_t len)
{
    R_SCI_UART_Write(&g_uart9_ctrl, p, len);
...
void vprint(const char *fmt, va_list argp) {
    ...
    {
        R_SCI_UART_Write(&g_uart9_ctrl, (uint8_t*)string, strlen(string));
    }
}
